            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button className="py-4 px-6 border-2 border-amber-600 text-amber-600 rounded-2xl font-bold hover:bg-amber-50 transition-all duration-300 flex items-center justify-center gap-2">
                  ...
                  <Link 
                    href="/checkout"
                    className="py-4 px-6 bg-stone-800 text-white rounded-2xl font-bold hover:bg-stone-900 transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(product.specifications).map(([key, value]) => (
                <div key={key} className="bg-gradient-to-br from-stone-50 to-amber-50 rounded-xl p-6 border border-stone-200">
                  <dt className="font-bold text-stone-900 text-lg capitalize mb-2">
